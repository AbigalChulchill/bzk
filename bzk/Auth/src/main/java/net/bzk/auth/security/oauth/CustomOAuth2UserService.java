package net.bzk.auth.security.oauth;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
	...
	private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
		...
		Optional<Account> userOptional = userRepository.findByUsername(oAuth2UserInfo.getEmail());
		Account user;
	...
	private Account registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
		...
		user.setPassword(oAuth2UserInfo.getEmail() + "NBXdeuuiu&^&zt1aoplq__&wxcbv!@nt6z");
